...
function sectionBuilder(data) {
	...
	responsiveDiv.style["overflow-x"] = "auto";
...
function columnsBuilder(data) {
	...
	for (column in data) {
		...
		var nodeText = document.createTextNode(columnData);
		node.appendChild(nodeText);
		columnsRow.appendChild(node);
	}
	return columnsRow;
}
...
function equipoCardBuilder(equipoData) {
	...
	var equipoImg = document.createElement("img");
	equipoImg.src = `/images/logos/equipos/${equipoAbbreviation}.png`;
	equipoImg.className = "equipo-img";
	equipoImg.loading = "lazy";
	equipoCard.appendChild(equipoImg);

	var equipoNameNode = document.createElement("p");
	equipoNameNode.appendChild(document.createTextNode(equipoName));
	equipoNameNode.className = "equipo-name";
	equipoCard.appendChild(equipoNameNode);
